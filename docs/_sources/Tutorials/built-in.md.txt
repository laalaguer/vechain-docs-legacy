# How to use built-in contracts

More information about  Multi-Party Payment Protocol please refer to the link as below.
[Multi-Party Payment Protocol (MPP)](doc:multi-party-payment-protocol-mpp) 
